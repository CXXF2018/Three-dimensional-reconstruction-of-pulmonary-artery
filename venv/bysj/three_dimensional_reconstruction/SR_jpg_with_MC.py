...
#vtk_reader.SetFilePrefix("D:/ct_2_jpg/")#文件夹路径
#vtk_reader.SetFilePrefix("E:/tmp/")#文件夹路径
vtk_reader.SetFilePrefix("D:/pyProject/Graduation_project/venv/bysj/test/image/")#文件夹路径
...
marchingCubes.SetValue(0, 180)#设置第i个等值面的值为value
