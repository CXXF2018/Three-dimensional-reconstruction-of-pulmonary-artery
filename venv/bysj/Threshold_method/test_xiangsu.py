...
# 对图像进行阈值分割
ret,img = cv2.threshold(img, 500,3071, cv2.THRESH_BINARY)
ret,mm = cv2.threshold(mm, 200,3071, cv2.THRESH_BINARY)
...
img1 = cv2.morphologyEx(img, cv2.MORPH_OPEN, kernel)#形态学运算：MORPH_OPEN 开运算
